...
values('admin','admin','265464742','10/11/1976','masculino','Rua José Justino Lima','517','Vila Siqueira','São Paulo','SP','02817077','Casa 2','11','28274786','11','988490174','admin@gmail.com','Ativo','01/01/2019', 'admin')

insert into tbl_Aluno (nomeAluno,CPF,RG,dataNasc,Genero,Logradouro,numEndereco,Bairro, Cidade,UF,CEP, Complemento, DDD1,telefone, DDD2, telefone_2, Email, alSituacao, dataCadastro, Senha)
values('Brenda Marli dos Santos','07849780850','265464742','10/11/1976','Feminino','Rua José Justino Lima','517','Vila Siqueira','São Paulo','SP','02817077','Casa 2','11','28274786','11','988490174','brenda@gmail.com','Ativo','01/01/2019', '1235')

insert into tbl_Aluno (nomeAluno,CPF,RG,dataNasc,Genero,Logradouro,numEndereco,Bairro, Cidade,UF,CEP, Complemento, DDD1,telefone, DDD2, telefone_2, Email, alSituacao, dataCadastro, Senha)
values('Enrico Mateus Márcio da Luz','93881285830','138429819','16/04/1989','Masculino','Largo Mestre de Aviz','350','Jardim Luzitânia','São Paulo','SP','04031070','não consta','11','26358852','11','991009664','enrico@gmail.com','Ativo','01/01/2019', '1235')

insert into tbl_Aluno (nomeAluno,CPF,RG,dataNasc,Genero,Logradouro,numEndereco,Bairro, Cidade,UF,CEP, Complemento, DDD1,telefone, DDD2, telefone_2, Email, alSituacao, dataCadastro, Senha)
values('Evelyn Clarice Carla Brito','78227334865','444979554','02/05/1962','Feminino','Travessa Waldemar Cordeiro','285','Cohab Monet','São Paulo','SP','05856590','não consta','11','26358852','11','991009664','evelyn@gmail.com','Ativo','01/01/2019', '1235')

insert into tbl_Aluno (nomeAluno,CPF,RG,dataNasc,Genero,Logradouro,numEndereco,Bairro, Cidade,UF,CEP, Complemento, DDD1,telefone, DDD2, telefone_2, Email, alSituacao, dataCadastro, Senha)
values('Benedito Pedro Henrique da Silva','31034785850','121432324','23/02/1989','Masculino','Rua Quintana 753','195','Cidade Monções','São Paulo','SP','04569900','não consta','11','25198850','11','982155599','benedito@gmail.com','Ativo','01/01/2019', '1235')

insert into tbl_Aluno (nomeAluno,CPF,RG,dataNasc,Genero,Logradouro,numEndereco,Bairro, Cidade,UF,CEP, Complemento, DDD1,telefone, DDD2, telefone_2, Email, alSituacao, dataCadastro, Senha)
values('Levi Luís Sales','85745141875','198140563','23/04/1989','Masculino','Avenida República do Líbano 2157','454','Ibirapuera','São Paulo','SP','04502903','não consta','11','26358852','11','991009664','levi@gmail.com','Ativo','01/01/2019', '1235')
...
insert into tbl_Professor (CPF, Senha, nomeProfessor, RG, dataNasc, Sexo, regCREF, Logradouro, numEndereco, Bairro, Cidade, UF, CEP, Complemento, DDD1, telefone, DDD2, telefone_2, Email, profSituacao, dataCadastro)
 values('admin','admin','Gustavo Raíz', '311869543','12/12/1982','Masculino', '013895-G/SP', 'Rua Garcia de Orta','698', 'Parque Independência','São Paulo', 'SP','5880290', 'Condominio Rosa','11','32353639', '11', '956565857','gustavo.raiz@gmail.com','Ativo','03/01/2019')
 
 insert into tbl_Professor (CPF, Senha, nomeProfessor, RG, dataNasc, Sexo, regCREF, Logradouro, numEndereco, Bairro, Cidade, UF, CEP, Complemento, DDD1, telefone, DDD2, telefone_2, Email, profSituacao, dataCadastro)
 values('06174322602','12345','Severino Pedro Henrique Lima', '285007415','12/12/1982','Masculino', '013897-G/SP', 'Rua Dezesseis','591', 'Santa Luzia','São Paulo', 'SP','65916590', 'não consta','11','9826562400', '11', '98981115520','severino@gmail.com','Ativo','01/01/2019')
...
insert into tbl_Funcionario (CPF, Senha, Cargo, nomeFuncionario, RG, dataNasc, Sexo, Logradouro, numEndereco, Bairro, Cidade, UF, CEP, Complemento, DDD1, telefone, DDD2, telefone_2, Email, funcSituacao, dataCadastro)
 values ('35835375808','12345','Atendente', 'Malu Clara Costa', '364986104','17/04/1989','Feminino','Rua M.M.D.C.','726','Butantã','São Paulo','SP','05510021', 'Não consta','11','996106289','11','936974965','malu@gmail.com','Ativo','01/01/2019')
